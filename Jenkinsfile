        ...
        stage('Scan') {
            parallel {
                stage('Black Duck Full Scan') {
                    ...
                    steps {
                        withCredentials([string(credentialsId: 'BLACKDUCK_URL', variable: 'MWFmY2U4NDQtMzZmMi00MDdiLWI5ZGUtNzAxNzMxMTU1MWZmOmE4NjRiZmQxLTgxNmMtNDgxYS05MmNhLWU4ZTBjMmViNTI0ZA==')]) {
                            script {
